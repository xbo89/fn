    ...
    <MenuContainer placement="top" class="inline-block">
      ...
      <template #floating>
        <BubbleContainer class="flex space-x-2">
          <input type="text" placeholder="Url" v-model="link" @mousedown.stop
          ...
          <BubbleToggleButton icon="i-ri-edit-box-line" v-show="!isEdit" @mousedown="editLinkHref" />
