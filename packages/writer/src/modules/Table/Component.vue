<template>
  <div ref="container" class="table-container relative">
    <div
      v-show="(!isAtLeft && !noScrollbar) || isInMiddle"
    ...
    <SimpleBar ref="simplebarElement" class="w-full whitespace-normal pb-3">
      <table ref="tableElement" data-nodeview-table class="w-96">
        <colgroup data-nodeview-colgroup />
        <tbody data-nodeview-tbody />
      </table>
    </SimpleBar>
    <div
      v-show="(!isAtRight && !noScrollbar) || isInMiddle"
...
function checkScrollPosition(e) {
  ...
  // 判断是否在中间状态
  isInMiddle.value = hasScrollbar && !isAtLeft.value && !isAtRight.value
